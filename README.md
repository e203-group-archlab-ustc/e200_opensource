...
Pre-About
-----------
这个仓库是蜂鸟E200项目的一个Fork。它在原项目的基础上增加了中国科学技术大学嵌入式系统实验室蜂鸟小组对蜂鸟E203的注释。除了添加注释外，没有对原项目做任何修改。

中国科学技术大学嵌入式系统实验室蜂鸟小组指导老师：
* 李曦（llxx@ustc.edu.cn）

中国科学技术大学嵌入式系统实验室蜂鸟小组成员：
* 汪超（wcwxy@mail.ustc.edu.cn）
* 周高超（zhougc@mail.ustc.edu.cn）
* 刘伟森（lws@mail.ustc.edu.cn）
...
```
/*
Coment by (第一次注释作者 -> 第二次注释作者 -> ... -> 上一次注释作者 ->）本次注释作者
空行
注释内容
*/
